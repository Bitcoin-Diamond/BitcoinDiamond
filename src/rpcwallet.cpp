...
void ThreadTopUpKeyPool(void* parg)
{
    ...
    RenameThread("bitcoindiamond-key-top");
...
void ThreadCleanWalletPassphrase(void* parg)
{
    ...
    RenameThread("bitcoindiamond-lock-wa");
...
Value validatepubkey(const Array& params, bool fHelp)
{
    if (fHelp || !params.size() || params.size() > 2)
        throw runtime_error(
            "validatepubkey <bitcoindiamondpubkey>\n"
            "Return information about <bitcoindiamondpubkey>.");
